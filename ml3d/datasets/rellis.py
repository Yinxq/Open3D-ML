...
class Rellis(BaseDataset):
    """This class is used to create a dataset based on the Rellis
    ...
    def __init__(self,
                 ...
                 use_cache=False,
                 class_weights=[447156890, 261005182, 107172982, 22852, 224173,
                 		 111345, 554091, 10626325, 1588416, 168764964,
                 		 10944799, 3502156, 1493276, 5798200, 3395458
                 ],
    ...
    def get_split(self, split):
        ...
        """
        return RellisSplit(self, split=split)
    ...
    def get_split_list(self, split):
        ...
        for seq_id in seq_list:
            pc_path = join(dataset_path, seq_id, 'os1_cloud_node_kitti_bin')
            file_list.append(
...
class RellisSplit(BaseDatasetSplit):
    ...
    def get_data(self, idx):
        ...
        label_path = join(dir, '../os1_cloud_node_semantickitti_label_id', file[:-4] + '.label')
...
DATASET._register_module(Rellis)
